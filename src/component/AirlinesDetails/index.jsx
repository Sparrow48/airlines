...
function Index() {
  ...
  return (
    <div className="flex flex-col items-center justify-center h-screen">
      <div className="max-w-sm p-6 m-auto bg-white border border-gray-200 rounded-lg shadow-md w-80 dark:bg-gray-800 dark:border-gray-700">
      ...
      <h1 className="p-8 text-white bg-blue-400 rounded">
        {" "}
        Page will be re-design soon with additional info
      </h1>
    </div>
  );
}
